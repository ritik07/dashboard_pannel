  ...
  return (
    <Card className="cs-tm-30">
      ...
      <Typography.Title level={5} type="secondary">
        Tailor your preference, update your personal information. Your account,
        your way
      </Typography.Title>
      ...
      <Row gutter={[20, 20]}>
        <Col xs={8}>
          <Typography.Title level={4}>Account Type</Typography.Title>
          <Typography.Title level={5} type="secondary">
      ...
      <Row className="cs-tm-40" gutter={[20, 20]}>
        ...
        <Col xs={6} className="cs-dis-flex cs-vt-center">
          <div>
            ...
            <div className={CSS.btn_disabled + " cs-tm-10 "}>Change email</div>
          </div>
        </Col>
      </Row>
      <Divider className="cs-tm-40" />
      ...
      <Row className="cs-tm-40" gutter={[20, 20]}>
        <Col xs={8}>
          <Typography.Title level={4}>Origisation Logo</Typography.Title>
          <Typography.Title level={5} type="secondary">
      ...
      <Row className="cs-tm-40" gutter={[20, 20]}>
        <Col xs={8}>
          ...
          <Typography.Title level={5} type="secondary">
            ...
            perferendis repellat commodi natus eligendi quibusdam architecto
            numquam
          </Typography.Title>
        </Col>
        ...
        <Col xs={6} className="cs-dis-flex cs-vt-center">
          <div>
            <div className={CSS.deactive_btn + " cs-tm-10 "}>
              Deactivate Account
            </div>
          </div>
        </Col>
